  ...
  return (
    <div className="flex w-screen h-screen justify-center items-center">
      <div className="bg-white min-w-fit flex flex-col justify-center space-y-5 xl:w-[30%] lg:w-[40%] md:w-[50%] sm:w-full xl:h-fit lg:h-fit md:h-fit h-full w-full sm:h-full items-center rounded-xl shadow-gray-500 shadow-2xl py-5 px-10">
        ...
        <input
          className="flex w-full border-[2px] border-[#cdcdcd] p-3 rounded-lg duration-300 hover:border-[#526D82] hover:border-2 focus:outline-none focus:border-[#526D82] text-black"
        ...
        <div className="flex w-full gap-2 flex-col justify-center items-center">
          <button
            onClick={() => router.push("/")}
            className="bg-[#27374D] rounded-lg flex w-full duration-300 justify-center items-center p-4 hover:shadow-lg hover:shadow-gray-500"
          >
            <span className="font-semibold">Sign In</span>
          </button>
          <button
            onClick={() => router.push("/registerpage")}
            className="bg-[#DDE6ED] shadow-xl rounded-lg flex w-full duration-300 justify-center items-center p-4 hover:shadow-lg hover:shadow-gray-500"
          >
        ...
        <div className="flex flex-row w-full justify-center items-center gap-2">
          ...
          <Link
            href={"/"}
            className="text-[#526D82] duration-300 hover:text-[#27374D]"
          >
            Click Here
          </Link>
        </div>
